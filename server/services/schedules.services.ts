...
import { SchedulesTable, insertScheduleModel, updateScheduleModel } from '@server/database/schemas';
import type { createScheduleModelType, updateScheduleModelType } from '@server/types';
