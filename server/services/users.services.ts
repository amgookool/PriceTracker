...
export const createUser = async (
  user: createUserModelType
): Promise<selectUserModelType> => {
  const validatedUserBody = insertUserModel.parse(user);
  validatedUserBody.password = await Bun.password.hash(
    validatedUserBody.password
  );
